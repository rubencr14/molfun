...
def list_collections(tag: str | None = None) -> list[CollectionSpec]:
    """
...
def fetch_collection(
    ...
    *,
    ...
    elif spec.pfam_id or spec.ec_number or spec.taxonomy_id or spec.go_id:
        pdb_ids = fetcher._search_rcsb(
            _build_simple_query(spec, res),
            max_results=max_s,
        )
    else:
